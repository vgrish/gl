gl.grid.City = function(config) {
    ...
    Ext.applyIf(config, {
        ...
        stateful: true,
        stateId: 'gl-grid-city-state'

    });
    gl.grid.City.superclass.constructor.call(this, config);

};
Ext.extend(gl.grid.City, MODx.grid.Grid, {
    windows: {},
...
Ext.reg('gl-grid-city', gl.grid.City);
