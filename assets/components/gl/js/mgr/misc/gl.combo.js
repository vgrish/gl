...
gl.combo.Class = function(config) {
    config = config || {};
    ...
    if (config.custm) {
        config.triggerConfig = [{
            ...
            cn: [{
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-class-go'
            }]
        }];
        if (config.clear) {
            config.triggerConfig[0].cn.push({
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-class-clear'
            });
        }
    ...
    gl.combo.Class.superclass.constructor.call(this, config);

};
Ext.extend(gl.combo.Class, MODx.combo.ComboBox);
Ext.reg('gl-combo-class', gl.combo.Class);
...
gl.combo.Identifier = function(config) {
    config = config || {};
    ...
    if (config.custm) {
        config.triggerConfig = [{
            ...
            cn: [{
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-identifier-go'
            }]
        }];
        if (config.clear) {
            config.triggerConfig[0].cn.push({
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-identifier-clear'
            });
        }
    ...
    Ext.applyIf(config, {
        ...
        hiddenName: config.name || 'identifier',
        displayField: 'name_ru',
        valueField: 'id',
        editable: true,
        fields: ['id', 'name_ru'],
        ...
        url: gl.config.connector_url,
        baseParams: {
            action: 'mgr/misc/identifier/getlist',
            combo: true,
            class: config.class || ''
        },
        tpl: new Ext.XTemplate(
    ...
    gl.combo.Identifier.superclass.constructor.call(this, config);

};
Ext.extend(gl.combo.Identifier, MODx.combo.ComboBox);
Ext.reg('gl-combo-identifier', gl.combo.Identifier);


gl.combo.Resource = function(config) {
    config = config || {};
    ...
    if (config.custm) {
        config.triggerConfig = [{
            ...
            cn: [{
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-resource-go'
            }]
        }];
        if (config.clear) {
            config.triggerConfig[0].cn.push({
                tag: 'div',
                cls: 'x-form-trigger x-field-gl-resource-clear'
            });
        }
    ...
    gl.combo.Resource.superclass.constructor.call(this, config);

};
Ext.extend(gl.combo.Resource, MODx.combo.ComboBox);
Ext.reg('gl-combo-resource', gl.combo.Resource);